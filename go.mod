...
require (
	...
	go.temporal.io/sdk v1.26.0-rc.2.0.20240214221834-30da688037d1 // indirect
...
replace github.com/coinbase/chainstorage => github.com/cipherowl-ai/chainstorage v0.0.0-20250212
